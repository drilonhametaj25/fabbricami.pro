...
const productRoutes: FastifyPluginAsync = async (server) => {
  ...
  // NOTA: le rotte GET/POST/PUT/DELETE per `/:id/variants` e `/:id/variants/:variantId`
  // sono state migrate al blocco multi-tenant più sotto (tenantMiddleware +
  // productVariantService). Vedi sezione "PRODUCT VARIANTS" ~r.2280.
